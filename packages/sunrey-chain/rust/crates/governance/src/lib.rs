...
impl UpgradeKind {
    pub fn parse(value: &str) -> Result<Self, RejectReason> {
        match value {
            ...
            "VALIDATOR_ECONOMIC_POLICY_CHANGE" => Ok(Self::ValidatorEconomicPolicyChange),
    ...
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::ValidatorEconomicPolicyChange => "VALIDATOR_ECONOMIC_POLICY_CHANGE",
