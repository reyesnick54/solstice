...
export const CAPABILITY_RESTRICTIONS: Readonly<Record<IndependentCapability, readonly EmergencyActionClass[]>> = {
  SUNREY_COIN_NATIVE_ASSET: Object.freeze([]),
  ...
  FIAT_BANKING: Object.freeze(['RESTRICT_SPECIFIC_PROTOCOL_FEATURE']),
  PAYMENT_RAILS: Object.freeze(['RESTRICT_SPECIFIC_PROTOCOL_FEATURE']),
  CARDS: Object.freeze(['RESTRICT_SPECIFIC_PROTOCOL_FEATURE']),
  INVESTMENTS: Object.freeze(['RESTRICT_SPECIFIC_PROTOCOL_FEATURE']),
  HUMAN_INFORMATION_MARKET: Object.freeze(['RESTRICT_SPECIFIC_PROTOCOL_FEATURE']),
