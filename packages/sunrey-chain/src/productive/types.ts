...
export const PRODUCTIVE_CONTRIBUTION_SCHEMA_V1 = 1 as const;
export const PRODUCTIVE_CONTRIBUTION_SCHEMA_V2 = 2 as const;
...
export const GOVERNED_VALUE_SIMULATION_PATH_CLASS = 'GOVERNED_VALUE_SIMULATION_V2' as const;
export const PRODUCTION_ISSUANCE_PATH_CLASS = 'PRODUCTION' as const;
export const ISSUANCE_PATH_CLASSES = [
  LEGACY_FORMULA_PATH_CLASS,
  GOVERNED_VALUE_SIMULATION_PATH_CLASS,
  PRODUCTION_ISSUANCE_PATH_CLASS,
] as const;
export type IssuancePathClass = (typeof ISSUANCE_PATH_CLASSES)[number];
...
export const HASH_DOMAIN_PRODUCTIVE_V2 = 'SUNREY_PRODUCTIVE_V2' as const;
export const PRODUCTIVE_FINGERPRINT_V1 = 'PRODUCTIVE_FINGERPRINT_V1' as const;
export const PRODUCTIVE_FINGERPRINT_V2 = 'PRODUCTIVE_FINGERPRINT_V2' as const;
