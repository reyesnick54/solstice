  ...
  const statements: Array<{ database: string; sql: string }> = [
    {
      ...
      sql: `TRUNCATE TABLE
              ...
              economic_knowledge_graph.claim_linkage,
              economic_knowledge_graph.match_suggestion,
              economic_knowledge_graph.entity_resolution,
              economic_knowledge_graph.alias,
              economic_knowledge_graph.edge,
              economic_knowledge_graph.node,
              ...
              investment.profile,
              regulatory_twin.disposition,
              regulatory_twin.readiness_assessment,
              regulatory_twin.impact_report,
              ...
              human_contribution.monetized_claim,
              human_contribution.proof_bound_claim,
              human_contribution.monetization_consumed_key,
              human_contribution.monetization_lock,
              human_contribution.resolution_claim,
              human_contribution.observation,
              human_contribution.verified_fingerprint,
              human_contribution.active_fingerprint,
              human_contribution.duplicate_attempt,
              human_contribution.contribution_record,
              human_contribution.snapshot,
              investment.reconciliation,
              investment.corporate_action,
              investment.valuation,
              investment.settlement,
              ...
              risk.stress_run,
              risk.assessment,
              risk.portfolio_snapshot,
              risk.limit_record,
              risk.budget,
              risk.stress_scenario,
              model_registry.approval,
              model_registry.validation,
    ...
    },
    {
      ...
      sql: `TRUNCATE TABLE
              ...
              ledger.outbound_webhook_delivery,
              ledger.outbound_webhook_subscription,
              ledger.inbound_webhook,
              ledger.async_workflow,
              ledger.async_job,
              ledger.dead_letter,
              ledger.inbox,
              ledger.outbox,
    ...
    },
    {
      ...
      sql: 'TRUNCATE TABLE security.credential_descriptor_ref, security.key_metadata, security.service_identity',
    },
  ];
