...
export const SIMULATION_EXECUTION_ROUTES: readonly ExecutionRouteDescriptor[] = Object.freeze([
  Object.freeze({
    ...
    supportedOrderActions: Object.freeze(['BUY', 'SELL'] as const),
  ...
  Object.freeze({
    ...
    providerEnvironment: 'simulation',
    supportedOrderActions: Object.freeze(['TRANSFER'] as const),
  ...
  Object.freeze({
    ...
    supportedOrderActions: Object.freeze(['BUY'] as const),
