...
const REGISTRY: readonly EventSchemaRecord[] = [
  ...
  { eventType: 'GrowthOpportunityDetected', version: 1, status: 'current' },
  { eventType: 'GrowthOpportunityLifecycleChanged', version: 1, status: 'current' },
  { eventType: 'GrowthOpportunityPreferencesUpdated', version: 1, status: 'current' },
  { eventType: 'GrowthOpportunitiesRecomputed', version: 1, status: 'current' },
  { eventType: 'WorkOrderCreated', version: 1, status: 'current' },
  { eventType: 'WorkOrderActivated', version: 1, status: 'current' },
  { eventType: 'WorkOrderPaused', version: 1, status: 'current' },
  { eventType: 'WorkOrderBlocked', version: 1, status: 'current' },
  { eventType: 'WorkOrderResumed', version: 1, status: 'current' },
  { eventType: 'WorkOrderCompleted', version: 1, status: 'current' },
  { eventType: 'WorkOrderCancelled', version: 1, status: 'current' },
  { eventType: 'WorkOrderExpired', version: 1, status: 'current' },
  ...
  { eventType: 'VaultRecordCreated', version: 1, status: 'current' },
  { eventType: 'VaultRecordUpdated', version: 1, status: 'current' },
  { eventType: 'VaultRecordSuperseded', version: 1, status: 'current' },
  { eventType: 'VaultRecordDeleted', version: 1, status: 'current' },
  { eventType: 'VaultCorrectionRequested', version: 1, status: 'current' },
  { eventType: 'VaultExportRequested', version: 1, status: 'current' },
  ...
  { eventType: 'StrategyCapsuleCreated', version: 1, status: 'current' },
  { eventType: 'StrategyCapsuleVersioned', version: 1, status: 'current' },
  { eventType: 'StrategyCapsuleFrozen', version: 1, status: 'current' },
  { eventType: 'EvaluationRequested', version: 1, status: 'current' },
  { eventType: 'StrategyCapsuleExpired', version: 1, status: 'current' },
  { eventType: 'StrategyCapsuleRevoked', version: 1, status: 'current' },
  ...
  { eventType: 'ExchangeOrderRejected', version: 1, status: 'current' },
  ...
  { eventType: 'ExchangeFillCreated', version: 1, status: 'current' },
  ...
  { eventType: 'ProviderDataInvalid', version: 1, status: 'current' },
  { eventType: 'ProviderDataStale', version: 1, status: 'current' },
  { eventType: 'ProviderSchemaChanged', version: 1, status: 'current' },
  { eventType: 'ProviderDataOutlier', version: 1, status: 'current' },
  { eventType: 'ProviderPayloadDuplicate', version: 1, status: 'current' },
  { eventType: 'ProviderRecordReceived', version: 1, status: 'current' },
  { eventType: 'ObservationNormalized', version: 1, status: 'current' },
  { eventType: 'ObservationRejected', version: 1, status: 'current' },
  { eventType: 'ObservationDeduplicated', version: 1, status: 'current' },
  { eventType: 'ObservationLinked', version: 1, status: 'current' },
  { eventType: 'EntityResolved', version: 1, status: 'current' },
  { eventType: 'EvidenceCreated', version: 1, status: 'current' },
  { eventType: 'FactVerified', version: 1, status: 'current' },
  { eventType: 'ClaimCreated', version: 1, status: 'current' },
  { eventType: 'ClaimChallenged', version: 1, status: 'current' },
  { eventType: 'ClaimResolved', version: 1, status: 'current' },
