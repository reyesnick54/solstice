...
export class ResearchIntelligenceService {
  ...
  getAuthor(authorId: string): Wave6ServiceResult<ResearchAuthor> {
    ...
    if (authorId.includes('smith')) {
      ...
      ]) as unknown as Wave6ServiceResult<ResearchAuthor>;
    }
    return summarize(observations) as unknown as Wave6ServiceResult<ResearchAuthor>;
  }
  ...
  getInstitution(institutionId: string): Wave6ServiceResult<ResearchInstitution> {
    ...
    return summarize(observations) as unknown as Wave6ServiceResult<ResearchInstitution>;
  }
...
export class Wave6OpportunityDataService {
  readonly #ctx: Wave6AdapterContext;
...
export type Wave6Services = {
  ...
  readonly opportunities: Wave6OpportunityDataService;
};
...
export function createWave6Services(ctx?: Wave6AdapterContext): Wave6Services {
  ...
  return Object.freeze({
    ...
    opportunities: new Wave6OpportunityDataService(context),
  });
}
