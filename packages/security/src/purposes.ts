...
export const PURPOSE_ALGORITHMS = Object.freeze({
  ...
  PROVIDER_AUTHENTICATION: 'HMAC-SHA256',
  ADMINISTRATION_SIGNING: 'HMAC-SHA256',
...
export const CHAIN_PURPOSE_DEFAULT_SUITE = Object.freeze({
  ...
  GENESIS_SIGNING: 'sunrey-ed25519-v1',
  RELEASE_SIGNING: 'sunrey-ed25519-v1',
  RECOVERY_SIGNING: 'sunrey-ed25519-v1',
