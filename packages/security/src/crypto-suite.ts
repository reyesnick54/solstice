...
export function defaultCryptoSuites(): readonly CryptoSuite[] {
  return [
    ...
    freezeCryptoSuite({
      ...
      symmetricAlgorithm: null,
      kdfAlgorithm: null,
      parameterProfile: 'fips-204-ml-dsa-65',
      purposes: CHAIN_SIGNING_PURPOSES,
      lifecycleState: 'DRAFT',
      permittedEnvironments: ['test'],
      introducedProtocolVersion: 'sunrey-protocol-0',
      activationEpoch: null,
      activationHeight: null,
      deprecationEpoch: null,
      deprecationHeight: null,
      verificationGracePolicy: grace(false, true),
      providerId: 'unselected-production-pq',
    }),
    freezeCryptoSuite({
      ...
      symmetricAlgorithm: 'AES-256-GCM',
      kdfAlgorithm: 'HKDF-SHA-256',
      parameterProfile: 'fips-203-ml-kem-768',
    ...
    freezeCryptoSuite({
      ...
      version: 1,
      signatureAlgorithm: 'SLH-DSA-SHA2-128S',
      kemAlgorithm: null,
      hashAlgorithm: 'SHA-256',
      symmetricAlgorithm: null,
      kdfAlgorithm: null,
      parameterProfile: 'fips-205-slh-dsa-sha2-128s',
      purposes: CHAIN_SIGNING_PURPOSES,
      lifecycleState: 'DRAFT',
      permittedEnvironments: ['test'],
      introducedProtocolVersion: 'sunrey-protocol-0',
