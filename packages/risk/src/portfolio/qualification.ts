...
export function evaluateM20PortfolioRiskQualification(
  checks: M20QualificationChecks,
): {
  readonly marker:
  ...
  const entries = Object.entries(checks) as [keyof M20QualificationChecks, boolean][];
