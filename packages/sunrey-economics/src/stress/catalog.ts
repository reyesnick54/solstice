...
export const ECONOMIC_STRESS_CATALOG: readonly EconomicStressScenario[] = Object.freeze([
  ...
  scenario('ECON-ACC-016', 'ACCESS', 'GPU-hour compute and metered AI capacity access', 7746, ['ACCESS_COMPUTE_CAPACITY'], null, 'ACCESS-13: compute access is metered capacity, not minted currency', 1),
  scenario('ECON-ACC-017', 'ACCESS', 'robot-hours and automated-service capacity access', 7747, ['ACCESS_ROBOT_CAPACITY'], 'AVAILABILITY_DEGRADATION', 'ACCESS-13: robot capacity refuses when a provider fails', 1),
  scenario('ECON-ACC-018', 'ACCESS', 'kWh energy capacity with verified delivery access', 7748, ['ACCESS_ENERGY_ACCESS'], null, 'ACCESS-13: energy access tightens under productive shock without inventing supply', 1),
]);
