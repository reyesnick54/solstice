...
const SIMULATION_ACCESS_FABRIC_ACTIONS = [
  'CONFIRM_CAPACITY_RESERVATION',
  'ACTIVATE_CAPACITY_RESERVATION',
] as const;
...
export const SIMULATION_CAPABILITIES: readonly LegalEntityCapability[] = [
  ...
  capability({
    ...
    actionTypes: [...SIMULATION_BANKING_ACTIONS],
    productIds: ['prod_demand_usd_us', 'prod_demand_sar_us'],
    productTypes: ['DEMAND_DEPOSIT'],
    environment: 'simulation',
    enabled: true,
  }),
  ...
  capability({
    ...
    actionTypes: [
      ...
      ...SIMULATION_ACCESS_FABRIC_ACTIONS,
