...
export const SIMULATION_CAPABILITIES: readonly LegalEntityCapability[] = [
  capability({
    ...
    actionTypes: ['OPEN_ACCOUNT', 'POST_DEPOSIT', 'POST_WITHDRAWAL', 'INTERNAL_TRANSFER'],
    productIds: ['prod_demand_usd_gb', 'prod_savings_usd_gb'],
    productTypes: ['DEMAND_DEPOSIT', 'SAVINGS_DEPOSIT'],
