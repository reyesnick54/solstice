...
export const COMMERCIAL_PROVIDER_REGISTRY: Readonly<Record<CommercialProviderId, CommercialProviderRegistration>> =
  Object.freeze({
    amadeus: Object.freeze({
      ...
      categories: Object.freeze(['TRAVEL', 'HOUSING_ROOM_NIGHTS', 'VEHICLE_HOURS', 'EXPERIENCES'] as const),
      contractStatus: 'NONE',
    ...
    booking_com: Object.freeze({
      ...
      categories: Object.freeze(['HOUSING_ROOM_NIGHTS', 'VEHICLE_HOURS'] as const),
