...
export {
  ...
  type AccessConceptOwner,
  type DuplicateTypeClassification,
  type NamedDuplicateType,
...
export {
  ACCESS_REGISTRY_ID_PREFIXES,
  accessRegistryIntentIdFor,
  accessRegistryRightIdFor,
  asCapacityRef,
  asDeliveryEvidenceRef,
  asReservationRef,
  capacityRefFor,
  type AccessRegistryIntentId,
  type AccessRegistryRightId,
  type CapacityRef,
...
} from './allocation-engine/index.ts';
