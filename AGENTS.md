...
- `packages/sunrey-chain` — SunRey Chain simulation trust layer; not a second ledger. Chunk 71 monetary constitution lives at `src/economics`. Chunk 108/112 human-contribution monetary evidence bridge lives at `src/economics/human-contribution-bridge`. Chunk 118 canonical economic unit normalization lives at `src/units`. Chunk 123 governed Productive Value Function constitution lives at `src/productive/policy-governance/value-function`. Chunk 127 off-chain economic data connector runtime lives at `src/oracle/production`. Not a second mint, unit authority, or oracle network. Production valuation remains inactive.
- `packages/sunrey-chain` — SunRey Chain simulation trust layer; not a second ledger. Chunk 71 monetary constitution lives at `src/economics`. Chunk 108/112 human-contribution monetary evidence bridge lives at `src/economics/human-contribution-bridge`. Chunk 118 canonical economic unit normalization lives at `src/units`. Chunk 123 governed Productive Value Function constitution lives at `src/productive/policy-governance/value-function`. Chunk 126 V2 shadow evaluation, migration readiness, and economic stress hardening lives at `src/productive/policy-governance/shadow-economics`. Not a second mint or second unit authority. Production valuation remains inactive.
- `packages/sunrey-chain` — SunRey Chain simulation trust layer; not a second ledger. Chunk 71 monetary constitution lives at `src/economics`. Chunk 108/112 human-contribution monetary evidence bridge lives at `src/economics/human-contribution-bridge`. Chunk 118 canonical economic unit normalization lives at `src/units`. Chunk 123 governed Productive Value Function constitution lives at `src/productive/policy-governance/value-function`. Chunk 125 Productive Value → MoonRey settlement conversion lives at `src/productive/policy-governance/value-settlement`. GPUV is not MoonRey. Not a second mint or second unit authority. Production valuation remains inactive.
...
- `packages/sunrey-chain` — Chunk 137 goods, commerce, and service delivery economic data fabric lives at `src/oracle/production/provider-families/goods` and `src/oracle/production/provider-families/services`. Extends production oracles. Order, invoice, and payment are not productive output. Not a second oracle, mint, or live commerce vendor. Production valuation remains inactive.
