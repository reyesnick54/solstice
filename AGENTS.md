...
- `packages/sunrey-chain` — SunRey Chain simulation trust layer; not a second ledger. Chunk 71 monetary constitution lives at `src/economics`. Chunk 108 human-contribution monetary evidence bridge lives at `src/economics/human-contribution-bridge`. Not a second mint or valuation engine.
