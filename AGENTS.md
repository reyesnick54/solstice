...
- `packages/human-economic-contribution` — Chunk 104 canonical Human Economic Contribution ontology and registry. Defines contribution classes and provenance. Not PEVE valuation, not SunRey issuance, not a human-worth score, not a second PEG, HIN, consent, clean-room, or monetary authority.
