...
describe('Growth Attribution Ledger', () => {
  it('defines exactly 14 sources and 4 realization classes', () => {
    assert.equal(GROWTH_SOURCES.length, 14);
    assert.equal(GROWTH_SOURCE_COUNT, 14);
