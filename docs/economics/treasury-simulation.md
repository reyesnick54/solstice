...
Chunk 76 is not present on this tree. Chunk 77 provides the treasury
stress catalog: budget exhaustion, duplicate disbursement, unauthorized
recipient, wrong asset, reservation race, fee revenue collapse, and large
emergency expense.
