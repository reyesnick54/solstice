...
| 0021 | Transaction and block encoding | ACCEPTED_FOR_ENGINEERING | RESEARCH_REQUIRED — no counsel review | SUNREY_CHAIN | ADR-0016, ADR-0019, ADR-0024 | PARTIAL (Chunk 32R envelope + protobuf codec; no block production) | [ADR-0021-sunrey-blockchain-transaction-block-encoding.md](./ADR-0021-sunrey-blockchain-transaction-block-encoding.md) |
