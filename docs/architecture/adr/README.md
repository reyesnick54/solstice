...
| 0017 | SunRey Blockchain consensus architecture | ACCEPTED_FOR_ENGINEERING | RESEARCH_REQUIRED — no counsel review | SUNREY_CHAIN | ADR-0016, ADR-0018 | IMPLEMENTED (development Tendermint-class engine; Chunk 61 bounded TLA+ safety model; production not implemented) | [ADR-0017-sunrey-blockchain-consensus-architecture.md](./ADR-0017-sunrey-blockchain-consensus-architecture.md) |
| 0018 | SunRey Blockchain validator architecture | ACCEPTED_FOR_ENGINEERING | RESEARCH_REQUIRED — no counsel review | SUNREY_CHAIN | ADR-0016, ADR-0017, ADR-0024 | IMPLEMENTED (development set + Chunk 39 accountability; not a public staking market) | [ADR-0018-sunrey-blockchain-validator-architecture.md](./ADR-0018-sunrey-blockchain-validator-architecture.md) |
...
| 0022 | Blockchain storage model | ACCEPTED_FOR_ENGINEERING | RESEARCH_REQUIRED — no counsel review | SUNREY_CHAIN | ADR-0016, ADR-0019, ADR-0021 | IMPLEMENTED (Chunk 67 production-candidate redb engine; file store retained as migration source) | [ADR-0022-sunrey-blockchain-storage-model.md](./ADR-0022-sunrey-blockchain-storage-model.md) |
...
| 0025 | Post-quantum migration architecture | ACCEPTED_FOR_ENGINEERING | RESEARCH_REQUIRED — no counsel review; not quantum-secure | SUNREY_CHAIN / SECURITY | ADR-0024, ADR-0028 | PARTIAL (Chunk 60: standardized PQ provider for development/testnet; production/HSM/certification pending) | [ADR-0025-sunrey-blockchain-post-quantum-migration.md](./ADR-0025-sunrey-blockchain-post-quantum-migration.md) |
| 0026 | Native asset model | ACCEPTED_FOR_ENGINEERING | RESEARCH_REQUIRED — no counsel review; tickers NOT_ASSIGNED | SUNREY_CHAIN / SUNREY_COIN | ADR-0019, ADR-0020, ADR-0031 | IMPLEMENTED (development native units + Chunk 71 monetary constitution; production quantities UNCONFIGURED) | [ADR-0026-sunrey-blockchain-native-asset-model.md](./ADR-0026-sunrey-blockchain-native-asset-model.md) |
| 0027 | Oracle architecture | ACCEPTED_FOR_ENGINEERING | RESEARCH_REQUIRED — no counsel review | SUNREY_CHAIN | ADR-0019, ADR-0020, ADR-0031 | IMPLEMENTED (Chunk 43 development oracle network; no live market-data network) | [ADR-0027-sunrey-blockchain-oracle-architecture.md](./ADR-0027-sunrey-blockchain-oracle-architecture.md) |
| 0028 | Governance and protocol upgrades | ACCEPTED_FOR_ENGINEERING | RESEARCH_REQUIRED — no counsel review | SUNREY_CHAIN | ADR-0016, ADR-0017, ADR-0021 | IMPLEMENTED (development height-activated UpgradePlan; production governance not implemented) | [ADR-0028-sunrey-blockchain-governance-upgrades.md](./ADR-0028-sunrey-blockchain-governance-upgrades.md) |
| 0029 | Interoperability model | ACCEPTED_FOR_ENGINEERING | RESEARCH_REQUIRED — no counsel review | SUNREY_CHAIN | ADR-0026, ADR-0031, ADR-0033 | IMPLEMENTED (development light-client gateway; production not implemented; no wrapped fiat) | [ADR-0029-sunrey-blockchain-interoperability.md](./ADR-0029-sunrey-blockchain-interoperability.md) |
...
| 0034 | SunRey Access Fabric / Human Access Economy | ACCEPTED_FOR_ENGINEERING | RESEARCH_REQUIRED — not a legal opinion | ACCESS_ECONOMY | personal-economic-graph, agent, sunrey-agent, kernel, permissions, ledger, exchange, custody, sunrey-chain, evidence | PARTIAL (ACCESS-01 foundation only) | [ADR-0034-sunrey-access-fabric.md](./ADR-0034-sunrey-access-fabric.md) |
