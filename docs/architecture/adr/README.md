...
| 0017 | SunRey Blockchain consensus architecture | ACCEPTED_FOR_ENGINEERING | RESEARCH_REQUIRED — no counsel review | SUNREY_CHAIN | ADR-0016, ADR-0018 | IMPLEMENTED (development Tendermint-class engine; production not implemented) | [ADR-0017-sunrey-blockchain-consensus-architecture.md](./ADR-0017-sunrey-blockchain-consensus-architecture.md) |
