...
| 0019 | SunRey Blockchain state machine architecture | ACCEPTED_FOR_ENGINEERING | RESEARCH_REQUIRED — no counsel review | SUNREY_CHAIN | ADR-0016, ADR-0020, ADR-0031 | PARTIAL (local development state machine) | [ADR-0019-sunrey-blockchain-state-machine-architecture.md](./ADR-0019-sunrey-blockchain-state-machine-architecture.md) |
...
| 0021 | Transaction and block encoding | ACCEPTED_FOR_ENGINEERING | RESEARCH_REQUIRED — no counsel review | SUNREY_CHAIN | ADR-0016, ADR-0019, ADR-0024 | PARTIAL (SRCB v1 local codec) | [ADR-0021-sunrey-blockchain-transaction-block-encoding.md](./ADR-0021-sunrey-blockchain-transaction-block-encoding.md) |
...
| 0024 | Cryptographic agility model | ACCEPTED_FOR_ENGINEERING | RESEARCH_REQUIRED — no counsel review | SUNREY_CHAIN / SECURITY | ADR-0009, ADR-0016, ADR-0025 | PARTIAL (local CryptoSuite port; not production-certified) | [ADR-0024-sunrey-blockchain-cryptographic-agility.md](./ADR-0024-sunrey-blockchain-cryptographic-agility.md) |
