...
| MoonRey Coin | Not implemented. Future native object on SunRey Blockchain if a later chunk implements it. Ticker `NOT_ASSIGNED` | Alias of SunRey Coin; invented ticker; fiat substitute |
