...
tests: 364 pass, 0 fail
  including: CHUNK-21 must stop while the protected risk and model-registry capabilities are PLANNED
  including: CHUNK-19 investment portfolio core capabilities are IMPLEMENTED
  including: CHUNK-18 Regulatory Digital Twin capabilities are IMPLEMENTED
  including: CHUNK-17 Personal Economic Value Engine is IMPLEMENTED on packages/platform
demo: ok
cards demo: ok
peg demo: ok
wallet demo: ok
