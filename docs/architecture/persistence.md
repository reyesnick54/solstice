...
| --- | --- | --- |
| `solstice_customer` | `customer_app` | customers, legal entities, identity schema (not a second customer), policy packs/versions/rules, capabilities, source references, manual-review cases, Personal Economic Graph projection, Growth Orchestrator mandate/plan rows |
