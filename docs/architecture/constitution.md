...
| Human contribution valuation constitution | `packages/human-economic-contribution` | `packages/human-economic-contribution/src/valuation/constitution.ts` | IMPLEMENTED |
