...
export function evaluateSandboxFeatureGates(nowUtc: string): SandboxFeatureGateReport {
  ...
  const gates = Object.freeze([
    ...
    gate('live_regulated_custody', 'Live regulated custody', LIVE_CUSTODY_ENABLED, 'LIVE_CUSTODY_ENABLED remains false', true),
    gate('live_banking_movement', 'Real banking movement', LIVE_PAYMENTS_ENABLED, 'LIVE_PAYMENTS_ENABLED remains false', true),
    gate('live_securities_execution', 'Real securities execution', LIVE_EXCHANGE_ENABLED, 'LIVE_EXCHANGE_ENABLED remains false', true),
    gate('live_provider_connectivity', 'Live provider connectivity', LIVE_CONNECTIVITY_ENABLED, 'LIVE_CONNECTIVITY_ENABLED remains false', true),
    gate('live_connectivity', 'Live connectivity', LIVE_CONNECTIVITY_ENABLED, 'LIVE_CONNECTIVITY_ENABLED remains false', true),
    gate(
