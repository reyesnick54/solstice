...
const ROUTE_AUTH: Readonly<Record<string, RouteAuthRequirement>> = Object.freeze({
  ...
  'POST /api/v1/exchange/quotes': Object.freeze({ capabilities: ['EXCHANGE_OPERATE_REQUEST'], requireVerified: true, denyRestricted: true, regulated: true }),
  ...
  'GET /api/v1/wallets/SRC': Object.freeze({ capabilities: ['EXCHANGE_VIEW'], requireVerified: true, denyRestricted: true, regulated: true }),
  'GET /api/v1/wallets/MRC': Object.freeze({ capabilities: ['EXCHANGE_VIEW'], requireVerified: true, denyRestricted: true, regulated: true }),
